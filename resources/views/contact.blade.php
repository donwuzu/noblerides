            ...
            <div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">2nd Sunrise Avenue, Ruiru<br>Nairobi, Kenya</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">
                                    <a href="tel:+254758845811" class="hover:text-blue-600 transition">+254 758 845 811</a><br>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">
                                    ...
                                    <a href="mailto:bookings@noblerides.co.ke" class="hover:text-blue-600 transition">bookings@noblerides.co.ke</a>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">
                                    ...
                                    <span class="text-sm text-blue-600">24/7 for airport transfers</span>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                {{-- <div class="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <div class="flex space-x-4">
                        <a href="#" class="bg-blue-100 p-3 rounded-full hover:bg-blue-200 transition">
                        ...
                        <a href="https://wa.me/254758845811" class="bg-blue-100 p-3 rounded-full hover:bg-blue-200 transition">
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d997.2511852902595!2d36.962258537730136!3d-1.1570932603185136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f40ade15f41e1%3A0xc1c23ecd3f2cd283!2s2nd%20Sunrise%20Ave%2C%20Ruiru!5e0!3m2!1sen!2ske!4v1751890604052!5m2!1sen!2ske" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></section>

<!-- CTA Section -->
<section class="py-16 bg-blue-600 text-white">
    <div class="container mx-auto px-4 text-center">
        <h2 class="text-2xl md:text-3xl font-bold mb-6">Need Immediate Assistance?</h2>
